  ...
  return (
    ...
    <Card className='Cards' style={{"borderRadius":"10px"}} >
      ...
      <Card.Body>
        ...
        <Col lg={2} md={2} sm={2} xs={2}> <Nav.Link   href="https://wa.me/+919392524565" style={{"paddingRight":"0px"}} ><img src={whatsapp} style={{"padding":"0px","marginTop":"-8px"}} width={48} alt="whatsapp"></img></Nav.Link></Col>
       <Col lg={4} md={4} sm={4} xs={4}><center> <Button variant='success' href="tel:+919392524565" style={{"background-color":"#049E79","border-radius":"10px"}}>CONTACT</Button></center></Col>
       </Row>
      </Card.Body>
    </Card>
    </Col>

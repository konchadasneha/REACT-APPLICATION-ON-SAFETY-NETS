...
function Carousel() {
  ...
  return (
    ...
    <div className="home_container"  data-aos="fade-up">
         ...
         <p className="heading2"  >SECURE NETS: Safeguarding Every Space, One Net at a Time. From balconies to construction sites, trust our safety nets to provide reliable protection against pests and accidents.</p>
         <a href="tel:+919392524565"  className="button">CALL NOW</a>
         </Container>
